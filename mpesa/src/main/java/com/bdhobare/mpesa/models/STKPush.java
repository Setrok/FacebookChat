...
public class STKPush {
    ...
    private STKPush(Builder builder) {
        ...
        //TEMP
        Log.i("GLOBAL STEP bSC=",this.businessShortCode);
        Log.i("GLOBAL STEP tS=",this.timestamp);
        Log.i("GLOBAL STEP PSW=",this.password);
        Log.i("GLOBAL STEP am=",this.amount);
        Log.i("GLOBAL STEP pA=",this.partyA);
        Log.i("GLOBAL STEP pB=",this.partyB);
        Log.i("GLOBAL STEP pNum=",this.phoneNumber);
        Log.i("GLOBAL STEP aRef=",this.accountReference);
        Log.i("GLOBAL STEP trDesc=",this.transactionDesc);
        Log.i("GLOBAL STEP cBURL=",this.callBackURL);
    ...
    public static class Builder {
        ...
        private String partyB;
        private String phoneNumber;
        private String callBackURL = "http://skillbar.esy.es/mpesa/mpesa.php";//https://mpesa.bdhobare.com/mpesa
        private String accountReference;
        private String transactionDesc;
